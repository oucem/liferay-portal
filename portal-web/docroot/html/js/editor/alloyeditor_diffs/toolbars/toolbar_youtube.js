YUI.add('toolbar-youtube', function(Y) {
    'use strict';
    ...
    var Lang = Y.Lang,
         ...
         * @class ToolbarImage
         */
        ToolbarYoutube = Y.Base.create('toolbaryoutube', Y.Widget, [Y.WidgetPosition, Y.WidgetPositionConstrain, Y.ToolbarBase, Y.ToolbarPosition], {
            /**
            ...
            _onEditorInteraction: function(event) {
                ...
                if (name === 'iframe') {
                    ...
                    element = this.get('editor').getSelection().getStartElement();
            ...
            BOUNDING_TEMPLATE: '<div class="alloy-editor-toolbar alloy-editor-toolbar-youtube alloy-editor-arrow-box ' +
    ...
    Y.ToolbarYoutube = ToolbarYoutube;
}, '', {
