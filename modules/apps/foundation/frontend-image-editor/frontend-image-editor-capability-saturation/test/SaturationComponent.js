...
import SaturationComponent from '../src/main/resources/META-INF/resources/SaturationComponent.es';
...
describe('SaturationComponent', () => {
	...
	before(done => {
		let assets = [getImageData('baseline.png'), getImageData('saturation_75.png')];
	...
	it('should apply a contrast effect to the image', (done) => {
		let component = new SaturationComponent({
