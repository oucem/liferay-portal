...
import ContrastComponent from '../src/main/resources/META-INF/resources/ContrastComponent.es';
...
describe('ContrastComponent', () => {
	...
	before(done => {
		let assets = [getImageData('baseline.png'), getImageData('contrast_75.png')];
	...
	it('should apply a contrast effect to the image', (done) => {
		let component = new ContrastComponent({
